...
(function ($) {
    ...
    var Swiper = function (container, params) {
        ...
        // Save instance in container HTML Element and in datas
            ...
            for (i = 0; i < s.slides.length; i++) {
                ...
                if (s.params.slidesPerColumn > 1) {
                    ...
                    slide
                        ...
                        .attr('datas-swiper-column', column)
                        .attr('datas-swiper-row', row);
        ...
        s.updateClickedSlide = function (e) {
            ...
            if (s.params.slideToClickedSlide && s.clickedIndex !== undefined && s.clickedIndex !== s.activeIndex) {
                ...
                if (s.params.loop) {
                    ...
                    realIndex = $(s.clickedSlide).attr('datas-swiper-slide-index');
                    if (s.params.centeredSlides) {
                        if ((slideToIndex < s.loopedSlides - s.params.slidesPerView/2) || (slideToIndex > s.slides.length - s.loopedSlides + s.params.slidesPerView/2)) {
                            s.fixLoop();
                            slideToIndex = s.wrapper.children('.' + s.params.slideClass + '[datas-swiper-slide-index="' + realIndex + '"]:not(.swiper-slide-duplicate)').eq(0).index();
                            setTimeout(function () {
        ...
        s.createLoop = function () {
            ...
            slides.each(function (index, el) {
                ...
                slide.attr('datas-swiper-slide-index', index);
            });
        ...
        s.destroyLoop = function () {
            s.wrapper.children('.' + s.params.slideClass + '.' + s.params.slideDuplicateClass).remove();
            s.slides.removeAttr('datas-swiper-slide-index');
        };
        ...
        s.lazy = {
            ...
            loadImageInSlide: function (index, loadInDuplicate) {
                ...
                img.each(function () {
                    ...
                    var background = _img.attr('datas-background');
                    var src = _img.attr('datas-src'),
                        srcset = _img.attr('datas-srcset');
                    s.loadImage(_img[0], (src || background), srcset, false, function () {
                        if (background) {
                            _img.css('background-image', 'url("' + background + '")');
                            _img.removeAttr('datas-background');
                        }
                        else {
                            if (srcset) {
                                _img.attr('srcset', srcset);
                                _img.removeAttr('datas-srcset');
                            }
                            if (src) {
                                _img.attr('src', src);
                                _img.removeAttr('datas-src');
                            }
                        ...
                        if (s.params.loop && loadInDuplicate) {
                            var slideOriginalIndex = slide.attr('datas-swiper-slide-index');
                            if (slide.hasClass(s.params.slideDuplicateClass)) {
                                var originalSlide = s.wrapper.children('[datas-swiper-slide-index="' + slideOriginalIndex + '"]:not(.' + s.params.slideDuplicateClass + ')');
                                s.lazy.loadImageInSlide(originalSlide.index(), false);
                            }
                            else {
                                var duplicatedSlide = s.wrapper.children('.' + s.params.slideDuplicateClass + '[datas-swiper-slide-index="' + slideOriginalIndex + '"]');
        ...
        s.hashnav = {
            init: function () {
                ...
                for (var i = 0, length = s.slides.length; i < length; i++) {
                    var slide = s.slides.eq(i);
                    var slideHash = slide.attr('datas-hash');
            ...
            setHash: function () {
                ...
                document.location.hash = s.slides.eq(s.activeIndex).attr('datas-hash') || '';
            }
        };
        ...
        function setParallaxTransform(el, progress) {
            ...
            p = el.attr('datas-swiper-parallax') || '0';
            pX = el.attr('datas-swiper-parallax-x');
            pY = el.attr('datas-swiper-parallax-y');
            if (pX || pY) {
                pX = pX || '0';
                pY = pY || '0';
            }
        ...
        s.parallax = {
            setTranslate: function () {
                s.container.children('[datas-swiper-parallax], [datas-swiper-parallax-x], [datas-swiper-parallax-y]').each(function(){
                    setParallaxTransform(this, s.progress);
        
                });
                s.slides.each(function () {
                    var slide = $(this);
                    slide.find('[datas-swiper-parallax], [datas-swiper-parallax-x], [datas-swiper-parallax-y]').each(function () {
            ...
            setTransition: function (duration) {
                ...
                s.container.find('[datas-swiper-parallax], [datas-swiper-parallax-x], [datas-swiper-parallax-y]').each(function(){
                    var el = $(this);
                    var parallaxDuration = parseInt(el.attr('datas-swiper-parallax-duration'), 10) || duration;
        ...
        s.cleanupStyles = function () {
            ...
            if (s.slides && s.slides.length) {
                s.slides
                    ...
                    .removeAttr('style')
                    .removeAttr('datas-swiper-column')
                    .removeAttr('datas-swiper-row');
            }
    ...
    var PhotoBrowser = function (params) {
        ...
        var template = pb.params.template ||
                        '<div class="photo-browser photo-browser-' + pb.params.theme + '">' +
                            '{{navbar}}' +
                            '{{toolbar}}' +
                            '<div datas-page="photo-browser-slides" class="content">' +
                                '{{captions}}' +
        ...
        var photoTemplate = !pb.params.lazyLoading ? 
            ...
            (pb.params.photoLazyTemplate || '<div class="photo-browser-slide photo-browser-slide-lazy swiper-slide"><div class="preloader' + (pb.params.theme === 'dark' ? ' preloader-white' : '') + '"></div><span class="photo-browser-zoom-container"><img datas-src="{{url}}" class="swiper-lazy"></span></div>');
        ...
        var captionTemplate = pb.params.captionTemplate || '<div class="photo-browser-caption" datas-caption-index="{{captionIndex}}">{{caption}}</div>';
        ...
        pb.onSliderTransitionStart = function (swiper) {
            ...
            if (pb.captions.length > 0) {
                ...
                var captionIndex = pb.params.loop ? swiper.slides.eq(swiper.activeIndex).attr('datas-swiper-slide-index') : pb.activeIndex;
                pb.captionsContainer.find('[datas-caption-index="' + captionIndex + '"]').addClass('photo-browser-caption-active');
            }
