        ...
        if (el) {
            ...
            if (el.dataset) {
                ...
                for (var i = 0; i < el.attributes.length; i++) {
                    ...
                    if (attr.name.indexOf('datas-') >= 0) {
                        dataset[$.toCamelCase(attr.name.split('datas-')[1])] = attr.value;
                    }
                }
            }
  ...
  var showTab = function (tab, tabLink, force) {
    ...
    if (tabLink) tabLink = $(tabLink);
      ...
      if (!tabLink || tabLink && tabLink.length === 0) {
        $('[datas-tab]').each(function () {
          if (newTab.is($(this).attr('datas-tab'))) tabLink = $(this);
        });
      }
    }
    ...
    if (oldTab && oldTab.length > 0) {
      ...
      if (!oldTabLink || oldTabLink && oldTabLink.length === 0) {
        $('[datas-tab]').each(function () {
          if (oldTab.is($(this).attr('datas-tab'))) oldTabLink = $(this);
        });
      }
    }
...
+function ($) {
  "use strict";
    ...
    function handleClicks(e) {
        ...
        //Collect Clicked datas- attributes
...
+function ($) {
  ...
  $.initCalendar = function(content) {
    ...
    $content.find("[datas-toggle='date']").each(function() {
      $(this).calendar();
    });
  };
}($);
...
+ function($) {
    ...
    $.initPullToRefresh = function(pageContainer) {
        ...
        if (container.attr('datas-ptr-distance')) {
        ...
        function handleTouchMove(e) {
            ...
            if (!isMoved) {
                ...
                if (dynamicTriggerDistance) {
                    triggerDistance = container.attr('datas-ptr-distance');
...
+ function($) {
    ...
    function handleInfiniteScroll() {
        ...
        var distance = inf[0].getAttribute('datas-distance');
...
+function ($) {
  ...
  $.fn.indexList.prototype.defaults = {
    ...
    indexListTemplate: "{{#indexes}}<li datas-index={{@index}}><strong>{{this}}</strong></li>{{/indexes}}"
  };
