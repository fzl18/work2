...
//			for (var i in e.pickers) {
			for(var i = 0; i < e.pickers.length; i ++){
				var n = e.pickers[i];
...
function(e, t) {
	...
	e.DtPicker = e.Class.extend({
		init: function(n) {
			...
			function() {
				var moduleDefineCode = n.moduleDefineCode;
				if(moduleDefineCode != null && moduleDefineCode != undefined){
					var rowNum = n.rowNum;
					putDateValue(a.getSelected(), n.moduleDefineCode, rowNum);
				} else {
