          ...
          >
            <FormItem {...formItemLayout} label="会员类型">
              ...
              {getFieldDecorator('ratio',{
                  ...
                  <InputNumber min={0} max={100} precision={0} style={{width:150}} placeholder='请输入'/>
              )} %
              </FormItem>
              ...
              {getFieldDecorator('voucherCount',{
                  ...
                  <InputNumber min={0} precision={0}  style={{width:150}} placeholder='（2小时通用券）'/>
              )} 张
              </FormItem>
...
export default class MemberProfit extends Component {
state = {
    loading:false,
    pagination:{
  ...
  del = (id) => {
    const options ={
        method: 'POST',
        url: API_URL.serive.deleteOrderRuleMemberProfit,
        data: {
            offset: 1,
            limit: 1,
            ruleMemberProfitId:id,
